...
1. **Application.** Developer pays a 1,000 ACT registration fee (to the management wallet — see `MANAGEMENT_FEE.md`, "Project registration fee," not yet built) and submits: location, technology, capital requirement, expected emissions reduction, project lifetime, beneficiaries, financial model, implementation plan, environmental/social information, monitoring methodology.
