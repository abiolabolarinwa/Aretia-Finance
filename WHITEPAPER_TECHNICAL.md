...
Financing climate mitigation and adaptation is not primarily a shortage of global capital; it is a shortage of capital willing to underwrite these projects at their riskiest, least-proven stage. The world requires an estimated $5.93 trillion a year in climate investment to stay on a 1.5°C-consistent path, a gap that has widened in relative terms even as total tracked climate finance more than doubled between 2018 and 2022, because concessional, risk-absorbing capital remains roughly 11 percent of that total and tracked adaptation finance specifically has plateaued near $64 billion a year.[^11] The deficit concentrates exactly where individual mitigation and adaptation projects are too small, too early, or too unproven for commercial and institutional capital to underwrite at acceptable risk-adjusted terms, which is precisely the gap that catalytic capital, capital that accepts disproportionate risk or concessionary terms specifically to unlock third-party investment that would not otherwise occur, is designed to close.[^12] This paper describes a protocol whose climate treasury is built to function as exactly this kind of catalytic fund: financing climate mitigation and adaptation projects through their highest-risk, least-bankable stage so that verified progress, rather than a developer's own account of it, becomes the basis on which commercial investors can eventually underwrite the same project on ordinary terms. The treasury is capitalized continuously by a protocol-enforced fee on ordinary, permissionless trading activity unconnected to any climate purpose, converting a fixed share of that activity into standing, de-risking capital rather than a one-time grant round that has to be re-raised. The conversion is enforced by the token's own transfer-fee extension rather than by policy, so the property holds by construction rather than by an operator's good conduct; that immutability applies to the aggregate fee rate specifically, a distinction Section 14 makes precise. Capital leaves the fund only against independently verified project milestones, because a catalytic claim is only as credible as the proof behind it: a fund cannot be said to have de-risked a project if its own account of that project's progress cannot be independently checked. Every step from withholding to disbursement is visible on a public ledger and independently reproducible by any observer. What follows sets out the theory of change, the token protocol and its arithmetic, project selection and governance, an economic and legal analysis, and an impact-documentation framework, closing with a proposed and explicitly unbuilt second capital stage in which projects the treasury has de-risked graduate toward commercial investment, gated by participation in ACT but never routed through the token itself, subject to prerequisites this paper states plainly rather than assumes.

---

## Part I. The Financing Challenge for Climate Mitigation and Adaptation Projects

## 1. The De-Risking Gap in Climate Mitigation and Adaptation Finance

Climate mitigation and adaptation projects fail to reach financial close for a reason that predates any question of verification: at the stage a project most needs capital, a first-of-kind technology deployment, an unproven developer, a small ticket size in a market institutional investors don't yet cover, the risk-adjusted return does not clear the threshold commercial and institutional capital requires. This is a de-risking problem, not fundamentally a capital-scarcity problem in the aggregate. Blended-finance practice defines the response directly: catalytic capital is capital, debt, equity, or guarantees, that accepts disproportionate risk or concessionary terms relative to a conventional investment specifically to improve a project's risk-return profile enough that private, commercial capital will then invest alongside or after it, on terms it otherwise would not have accepted.[^12] A 2023 Harvard Kennedy School working paper from the Mossavar-Rahmani Center for Business and Government treats thoughtful catalytic capital deployment as a precondition for mobilizing the private investment climate mitigation now requires, not an optional supplement to it.[^13] The scale of the gap this literature is responding to is not abstract: concessional, catalytic capital was roughly 11 percent of a global climate finance flow that itself covers barely a sixth of what a 1.5°C-consistent path requires each year.[^11]

Verification enters this picture as the mechanism that makes a catalytic claim checkable rather than as the paper's starting diagnosis. A capital provider claiming to have de-risked a project by financing it through its riskiest stage is making an empirical claim, that the milestones it funded were actually met, that can be true or false; if that claim cannot be independently checked, the same failure mode that has long undermined climate philanthropy and the voluntary carbon market reappears in catalytic form. Corporate climate commitments rose roughly 227 percent in the eighteen months to mid-2025, even as voluntary carbon credit retirements, the step that proves a credit was actually used rather than banked and forgotten, fell 7 percent over the same period.[^1] Commitment outpaced proof, and the divergence is itself the diagnostic. More recent data suggests the gap is narrowing, but from the supply side: first-half 2026 retirements held near 98 million credits while new issuance fell 31.9 percent year over year, to about 96.8 million.[^2] Supply and demand moved closer together, but a smaller, better-balanced market is not the same claim as a more reliably verified one.

The mechanisms conventionally available to deploy catalytic capital, grants, offset purchases, corporate pledges, share a common defect: each depends on a promise being honored after money or intent has already moved, and a grantor rarely audits its own grantee with the rigor an adversary would apply, so the catalytic claim behind the capital is asserted rather than demonstrated. A related but distinct problem affects projects that have already cleared their technical risk: a pilot with no doubt about its underlying engineering frequently cannot secure capital to scale, because conventional catalytic vehicles are capitalized through discrete fundraising events poorly suited to incremental, milestone-based de-risking. A fund capitalized continuously, rather than through periodic raises, is structurally better matched to that need than either a one-time grant or a loan sized for a single disbursement.

None of this presumes bad faith on the part of existing catalytic or philanthropic capital providers. It is a claim about incentive structure: a system in which the proof behind a de-risking claim is optional, delayed, and self-administered will tend, in aggregate, toward exactly the pattern the data already shows. The correction is not moral exhortation but mechanism design. If a catalytic claim cannot reliably be verified by voluntary conduct, it must be verified by structure, a requirement Section 9 returns to directly in defining this fund's own catalytic role and the metric against which that role should eventually be judged.

## 2. Why Existing Approaches Fall Short

A mechanism paper is incomplete if it does not explain what it is not. Four existing categories each address part of the de-risking gap, not the whole of it.
...
[^11]: Annual global climate investment need, the concessional-finance share of total tracked climate finance, and the plateau in tracked adaptation finance near $64 billion, per Climate Policy Initiative, "Global Landscape of Climate Finance 2024" and related CPI publications on concessional climate finance.

[^12]: Definition of catalytic capital as capital, debt, equity, or guarantees, accepting disproportionate risk or concessionary returns relative to a conventional investment to generate positive impact and enable third-party investment that would not otherwise be possible, per the Catalytic Capital Consortium (a collaboration of the John D. and Catherine T. MacArthur Foundation, the Rockefeller Foundation, and Omidyar Network, launched 2019); consistent with Convergence Blended Finance's treatment of blended finance as the use of catalytic capital to improve a project's risk-return profile enough to mobilize private co-investment.

[^13]: Andrea Boza Zanatta, "Advancing Equity in Climate Investments with Catalytic Capital," M-RCBG Associate Working Paper No. 215, Mossavar-Rahmani Center for Business and Government, Harvard Kennedy School (2023), prepared for Prime Coalition.
